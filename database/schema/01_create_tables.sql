...
-- 
-- INSTRUCTIONS:
-- 1. Create your library: CRTLIB LIB(YOURLIB) TEXT('Query Runner Application')
-- 2. Set schema: SET SCHEMA YOURLIB;
-- 3. Run this script
--
-- ============================================================================

-- Table 1: QRYRUN_USERS
...
-- Table 4: QRYRUN_SET_REFRESH_LOG
...
-- Table 9: QRYRUN_COMPARISON_DETAILS
...
-- Success message
SELECT 'All tables created successfully!' AS MESSAGE FROM SYSIBM.SYSDUMMY1;